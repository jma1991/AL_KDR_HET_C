...
Check if pyscenic grn output file is already present: 

```{r cache = FALSE}
if (file.exists("output/pyscenic/grn.csv")) {
  run <- FALSE
} else {
  run <- TRUE
}
...
```{bash cache = FALSE, eval = run, engine.opts = "-l"}
...
Check if pyscenic ctx output file is already present:

```{r cache = FALSE}
if (file.exists("output/pyscenic/ctx.csv")) {
  run <- FALSE
} else {
  run <- TRUE
}
...
Check if pyscenic aucell output file is already present:

```{r cache = FALSE}
if (file.exists("output/pyscenic/aucell.csv")) {
  run <- FALSE
} else {
  run <- TRUE
}
